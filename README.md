...
A personal knowledge base for myself built on a Claude agent. My raw notes go in, a cited wiki comes out, and every claim traces back to the file it came from. Comes with an Electron app that shows the library live and runs the ingest through headless Claude Code.
